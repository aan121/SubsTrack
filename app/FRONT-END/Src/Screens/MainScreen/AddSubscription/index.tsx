...
const AddSubscription = (props: any) => {
  ...
  const handleConfirm = async () => {
    ...
    try {
      const docRef = await addDoc(collection(FIREBASE_DATABASE, 'subscriptions'), newSubscription);
      console.log('Subscription added with ID: ', docRef.id);
  
      const subscriptionWithId = { ...newSubscription, id: docRef.id }; // Add id property
      addSubscription(subscriptionWithId); // Add the subscription
