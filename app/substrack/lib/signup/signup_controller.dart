...
class SignUpController extends GetxController {
  ...
  void userSubmit() {
    ...
    if (email.isEmpty) {
      ...
      EasyLoading.dismiss();
      cancelSnackBar("Error!", "Please enter a valid password!");
      return;
      ...
      EasyLoading.dismiss();
      cancelSnackBar("Error!", "Please enter your first name!");
      return;
    } else if (lastName.isEmpty) {
      EasyLoading.dismiss();
      cancelSnackBar("Error!", "Please enter your last name!");
      return;
    } else {
    ...
    try {
      ...
      if(userCredential!=null){
        ...
        database.child(uid).set(userData).then((_) {
          ...
          successfullySnackBar("Congratulations!", "Data added successfully");

        }).catchError((error) {
          EasyLoading.dismiss();
          cancelSnackBar("Error!", "Failed to add data");
        });
      }
      ...
      EasyLoading.dismiss();
      cancelSnackBar("Error", e.toString());
