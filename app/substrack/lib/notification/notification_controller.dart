    ...
    if (subscriptionModel.subscriptionCycle == "Weekly") {
      if (differenceInDays >= 0 && differenceInDays <= 3) {
        ...
        NotificationService().showNotification(
            title: 'Subscription Expires in $differenceInWeeks days',
            body:
                '${subscriptionModel.subscriptionCycle}');
      }
    } else if (subscriptionModel.subscriptionCycle == "Monthly") {
      if (differenceInDays >= 0 && differenceInDays <= 3) {
        totalNotification++;
        NotificationService().showNotification(
            title: 'Subscription Expires in $differenceInMonths days',
            body:
                '${subscriptionModel.subscriptionCycle}');
      }
      ...
      if (differenceInDays >= 0 && differenceInDays <= 3) {
        totalNotification++;
        NotificationService().showNotification(
            title: 'Subscription Expires in $differenceInDays days',
            body:
                '${subscriptionModel.subscriptionCycle}');
      }
      ...
      if (differenceInDays >= 0 && differenceInDays <= 3) {
        ...
        NotificationService().showNotification(
            title: 'Subscription Expires in $differenceInDays days',
            body: '${subscriptionModel.subscriptionCycle}');
      }
